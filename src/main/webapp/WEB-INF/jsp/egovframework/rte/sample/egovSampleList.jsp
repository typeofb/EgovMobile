			...
			<form:form name="listForm" method="post" commandName="searchVO1">
				...
				<div id="search">
					<fieldset>
						...
						<button type="button" id="searchSubmit" data-role="none" onclick="javascript:fn_egov_selectList();">
							<span><strong>검색</strong></span>
						</button>
					</fieldset>
				</div>
				...
				<ul data-role="listview" data-inset="true" data-dividertheme="a">
					<c:forEach var="result" items="${resultList}" varStatus="status">
						...
						<li><a href="javascript:fn_egov_select('<c:out value="${result.id}"/>');">
								...
								<p><strong>사용여부 : <c:out value="${result.useYn}" /></strong></p> <br>
